...
- Never reveal, print, quote, summarize, copy, or expose the user's agent API token, end-user backend API key, or any value from `{baseDir}/config/agents-workspace-api-access.config.json`.
